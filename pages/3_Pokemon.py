...
st.set_page_config(page_title="Pokemon Arena - HW1", page_icon="⚔️", layout="wide", initial_sidebar_state="collapsed")
...
.block-container { max-width: 1180px !important; padding: 1rem 1.8rem 1.2rem !important; }
.hw1-nav {
...
<nav class="hw1-nav">
  ...
  <span class="hw1-active">&#9876;&#65039; Task 3 - Pokemon Arena</span>
