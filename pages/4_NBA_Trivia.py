...
st.set_page_config(page_title="NBA SQL Trivia - HW1", page_icon="🏀", layout="wide", initial_sidebar_state="collapsed")
...
<nav class="hw1-nav">
  ...
  <span class="hw1-active">&#127936; Task 4 - NBA SQL Trivia</span>
