...
st.set_page_config(page_title="SQL Minesweeper - HW1", page_icon="💣", layout="wide", initial_sidebar_state="collapsed")
...
<nav class="hw1-nav">
  ...
  <span class="hw1-active">&#128163; Task 5 - SQL Minesweeper</span>
